...
import { executeBehaviorCommand, verifyBehaviorCommand } from "../../modules/world/runtime/behavior/BehaviorCompiler.js";
...
try{
  ...
  const appleManifest=runtime.assetModule.getManifest(assetId);
  ...
  mark("world.pipeline.ready",{
    ...
    objects:runtime.queries.listObjects()
  });
