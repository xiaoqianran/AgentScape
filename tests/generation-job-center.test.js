...
import { capabilityHint,generationJobActions,generationJobCenterMarkup,generationStatusLabel,parseGenerationInputs } from '../generation/orchestration/GenerationJobCenter.js';
...
describe('Generation Job Center view model',()=>{
  ...
  it('keeps import, compile/register, spawn, and cost confirmation as separate product actions',()=>{
    ...
    expect(markup).toContain('本地适配器（可选）');
