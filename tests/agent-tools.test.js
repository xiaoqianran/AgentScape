...
const runtime = () => ({ events: { emit: vi.fn() }, listObjects: vi.fn(() => []), spawn: vi.fn(), duplicate: vi.fn(), remove: vi.fn(), interactions: { move: vi.fn(), pickup: vi.fn(), drop: vi.fn(), place: vi.fn(), setDoor: vi.fn() } });
