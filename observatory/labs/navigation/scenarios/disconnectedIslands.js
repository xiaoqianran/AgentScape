export const navigationDisconnectedScenario = {
  ...
  description: "两块平台之间保留宽间隙，验证 Recast/Detour 对 disconnected islands 返回 NO_PATH/PARTIAL_PATH。",
  async setup(ctx) {
  ...
  assertions(ctx) {
    ...
    return [
      ...
      { label: "两岛之间不可达", pass: debug.route?.reachable === false, detail: debug.route?.reason || "unexpected reachable" },
