...
const DISPLAY_KEYS = Object.freeze({
  ...
  backend: "后端", renderer: "Renderer", "render backend": "渲染后端", "render mode": "渲染模式", "render fallback": "渲染回退", "render health": "渲染健康", "gpu timing": "GPU Timing", "gpu render": "GPU 渲染耗时", "timestamp query": "Timestamp Query", "webgpu compatibility": "WebGPU 兼容模式", solver: "求解器", bodies: "刚体数", colliders: "碰撞体数", joints: "关节数", contacts: "接触数", entities: "实体数",
