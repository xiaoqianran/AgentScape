...
for(const p of providerPaths){
  if(!/^providers\/modal\/(image-agent|connector|object3d-agent)$/.test(p)){
    failures.push(`${p}: provider repository is outside the pinned provider-client ownership tree`);
  }
}
