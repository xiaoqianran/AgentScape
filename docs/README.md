...
- [`spatial.md`](spatial.md)：Spatial 只读几何查询边界：snapshot、overlap、support/containment geometry、query purity 与 Interaction 依赖方向。
...
- [world-authoring-v1.md](world-authoring-v1.md)：World Authoring v1 冻结架构、边界、Studio 持久化与验证基线。
- [`world-authoring.md`](world-authoring.md)：外部 LLM 的 Three.js Authoring Subtree、AuthoringState / AuthoringDocument 中间态与持久化 round-trip。
